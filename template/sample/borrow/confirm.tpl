    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="/sample/do_confirm.php">借版记录</a></li>
                <li><a href="#">确定样板</a></li>
            </ol>
        </section>
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <a href="/sample/index.php" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> 添加样板</a>
                        ...
                        <tbody>
                            <{foreach from=$data.listGoodsInfo item=item}>
                                <tr <{if $item.online_status eq $data.onlineStatus.offline}> class="danger"<{/if}>>
                                    ...
                                    <td><{$sampleType[$item.sample_type]}></td>
                                    <td>
                                        <a href="/sample/borrow/cart_delete.php?goods_id=<{$item.goods_id}>" class="btn btn-warning btn-xs goods-cart-del"><i class="fa fa-trash"></i> </a>
                                    </td>
                                </tr>
                            <{/foreach}>
                        </tbody>                
...
$(function(){
    ...
    $('#delMulti').click(function(){
        ...
        $.post('/sample/borrow/ajax_cart_delete.php', {
            goods_id              : chk_value,
            ...
            if (0 != response.code) {
                ...
                location.href='/sample/borrow/do_confirm.php';
            }
