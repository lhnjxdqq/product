    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-body">
                        <div>
                            <form action="/sample/borrow/do_perfect.php" method="post" class='form-horizontal' enctype="multipart/form-data" onsubmit="return disableForm()">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-daterange input-group input-group-sm">
                                            <input type="text" name="borrow_time" readonly class="form-control daterange" value="<{$salesOrderInfo.order_time}>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-daterange input-group input-group-sm">
                                            <input type="text" name="estimate_return_time" readonly class="form-control daterange" value="<{$salesOrderInfo.order_time}>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <textarea class="form-control" name='remark' rows="3"><{$salesOrderInfo.order_remark}></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
