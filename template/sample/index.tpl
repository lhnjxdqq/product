    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="javascript:void(0);">样板管理</a></li>
                <li class="active">样板列表</li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="box">
                ...
                <form action="/sample/index.php" method="get" class="search-sku">
                    <div class="box-body">
...
<script>
    ...
    $('.goods-sample-del').click(function () {
