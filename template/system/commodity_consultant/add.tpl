        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                            <form action="/system/commodity_consultant/do_add.php" method="post">
                                <div class="form-group">
                                    <label>商品顾问花名: </label>
                                    <input type="text" name="commodity_consultant_name" class="form-control" placeholder="请输入花名">
                                </div>
                                <div class="form-group">
                                        <label>系统用户:</label>
                                        <div>
