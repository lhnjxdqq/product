        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                            <form action="/system/user/do_edit.php" method="post">
                                <div class="form-group">
                                    <label>登录账号: </label>
                                    <input type="text" name="username" class="form-control" placeholder="请输入登录账号" value="<{$data.userInfo.username}>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>登录密码: </label>
                                ...
                                <div class="form-group">
                                    <input type="hidden" name="user-id" value="<{$data.userInfo.user_id}>">
