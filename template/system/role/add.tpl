        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                            <form action="/system/role/do_add.php" method="post">
                                <div class="form-group">
                                    <label>角色名称: </label>
                                    <input type="text" name="role-name" class="form-control" placeholder="请输入角色名称">
                                </div>
                                <div class="form-group">
                                    <label>角色描述: </label>
                                    <input type="text" name="role-desc" class="form-control" placeholder="请输入角色描述">
                                </div>
                                <div class="form-group">
