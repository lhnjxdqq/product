                                ...
                                <{foreach from=$listUpdateInfo item=item}>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/common/download.php?file=<{$item.diff_file_path|urlencode}>&module=diff_cost_export&file_name=<{$item.update_cost_name}>" class="btn btn-primary btn-xs"><i class="fa fa-download"></i> 下载差价表</a>
                                            <{/if}>
                                        </td>
                                    </tr>
                                <{/foreach}>
