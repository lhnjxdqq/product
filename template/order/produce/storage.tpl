                                ...
                                <{foreach from=$mapProduceOrderArriveInfo item=item}>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <{/if}>
                                            <{if $item.is_storage eq 0}>
                                            <a href='/order/produce/del_import_error.php?produce_order_id=<{$smarty.get.produce_order_id}>&produce_order_arrive_id=<{$item.produce_order_arrive_id}>' class='btn btn-warning btn-xs'>删除</a>
                                            <{/if}>
                                        </td>
                                    </tr>
                                <{/foreach}>
