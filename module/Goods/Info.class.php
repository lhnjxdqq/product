...
class   Goods_Info {
     ...
     * 字段
     */
    const   FIELDS      = 'goods_id,goods_sn,goods_name,goods_type_id,goods_id_related,is_add_sample,sample_type,category_id,style_id,self_cost,sale_cost,goods_remark,online_status,delete_status,create_time,update_time';
    /**
     * 新增
     *
     * @param   array   $data   数据
