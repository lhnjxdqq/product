...
class   Produce_Order_Info {
     ...
     * 字段
     */
    const   FIELDS      = 'produce_order_id,produce_order_sn,produce_order_remark,sales_order_id,supplier_id,prepaid_amount,arrival_date,order_type,status_code,create_time,update_time';
    /**
     * 新增
     *
     * @param   array   $data   数据
