<?php
class Produce_Order_Arrive_Product_List {
    ...
    static private function _condition (array $condition) {
        ...
        $sql[]      = self::_conditionBySpuId($condition);
     ...
     * @return string
     */
    static private function _conditionBySpuId (array $condition) {

        if(empty($condition['spu_id'])){
            
            return ;
        }
        return '`spu_info`.`spu_id` ='. (int) $condition['spu_id'];
    }
    ...
    static private function _conditionByColorId (array $condition) {
        ...
        if(empty($condition['color_id'])){
            
            return ;
        }
        return '`color_info`.`spec_value_id` ='. (int) $condition['color_id'];
    }
