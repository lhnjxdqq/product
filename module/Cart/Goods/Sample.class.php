...
class   Cart_Goods_Sample {
     ...
     * 表名
     */
    const   TABLE_NAME  = 'cart_goods_sample';

    /**
     * 字段
     */
    const   FIELDS      = 'goods_id,user_id';
    /**
     * 新增
     *
     * @param   array   $data   数据
    ...
    static  public  function update (array $data) {
        ...
        $options    = array(
            'fields'    => self::FIELDS,
            'filter'    => 'goods_id,user_id',
        );
        $condition  = "`goods_id` = '" . addslashes($data['goods_id']) . "' AND `user_id` = '" . addslashes($data['user_id']) . "'";
        $newData    = array_map('addslashes', Model::create($options, $data)->getData());
    ...
    static  public  function delete (array $data) {
        ...
        $condition  = "`user_id` = '" . addslashes($data['user_id']) . "' AND `goods_id` = '" . addslashes($data['goods_id']) . "'";
